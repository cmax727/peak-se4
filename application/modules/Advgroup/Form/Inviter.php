...
class Advgroup_Form_Inviter extends Engine_Form
{
  ...
  public function init()
  {
    ...
    $this
      ...
      ->setDescription('Invite your friends to join! Enter email addresses separated by commas in the recipients box below. If your friends decide to sign up, they will be automatically added to your group.')
      ->setLegend('');
