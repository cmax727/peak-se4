<?php
class Advgroup_Model_Post extends Core_Model_Item_Abstract
{
  protected $_parent_type = 'advgroup_topic';
  ...
  {
    return Engine_Api::_()->getItem('advgroup_topic', $this->topic_id);
  }
