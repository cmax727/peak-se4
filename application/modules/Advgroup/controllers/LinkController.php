...
class Advgroup_LinkController extends Core_Controller_Action_Standard
{
  ...
  return $this->_helper->redirector->gotoRoute(array('id'=> $group->group_id,'action' => 'manage'), 'group_link', true);
}
  public function manageAction(){
    if(Engine_Api::_()->core()->hasSubject()) $this->view->group = $group = Engine_Api::_()->core()->getSubject();
    else  $this->view->group = $group = Engine_Api::_()->getItem('group',$this->_getParam('id'));
