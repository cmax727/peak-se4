...
class Advgroup_MemberController extends Core_Controller_Action_Standard
{
    ...
    if( $subject->membership()->isMember($viewer) ) {
      ...
      try
      {
        ...
        $notification = Engine_Api::_()->getDbtable('notifications', 'activity')->getNotificationByObjectAndType(
          $viewer, $subject, 'advgroup_invite');
        if( $notification )
        {
  ...
  public function promoteAction()
  {
    ...
    if( !$group->membership()->isMember($user) ) {
      throw new Advgroup_Model_Exception('Cannot add a non-member as an officer');
    }

    $this->view->form = $form = new Advgroup_Form_Member_Promote();
  ...
  public function demoteAction()
  {
    ...
    if( !$group->membership()->isMember($user) ) {
      throw new Advgroup_Model_Exception('Cannot remove a non-member as an officer');
    }

    $this->view->form = $form = new Advgroup_Form_Member_Demote();
  ...
  public function removeAction()
  {
    ...
    // Make form
    $this->view->form = $form = new Advgroup_Form_Member_Remove();
  ...
  public function inviteAction()
  {
    ...
    // Prepare form
    $this->view->form = $form = new Advgroup_Form_Invite();
  ...
  public function approveAction()
  {
    ...
    // Make form
    $this->view->form = $form = new Advgroup_Form_Member_Approve();
