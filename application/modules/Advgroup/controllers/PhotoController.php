...
class Advgroup_PhotoController extends Core_Controller_Action_Standard
{
  ...
  public function uploadAction()
  {
    ...
    $viewer = Engine_Api::_()->user()->getViewer();
    if(!$album_id = $this->_getParam('album_id')) $album = $group->getSingletonAlbum();
    else $album = Engine_Api::_ ()->getItem ('advgroup_album', $album_id);
    ...
    try
    {
      ...
      $action = $api->addActivity(Engine_Api::_()->user()->getViewer(), $group, 'advgroup_photo_upload', null, array(
