...
<table>
    <tr>
        <td id="manual_content" style="display: block; padding-left:10px;">
    ...
    <tr>
        <td id="file_content" style="display: none; padding-left:10px;">
            <div id="uploadcsvform3" >
                <form method="post" action="<?php echo $this->url(); ?>?format=smoothbox"  class="global_form_popup" enctype="multipart/form-data" onsubmit="sending_request();">
                    ...
                    <br>
                    <br>
                    <button type="submit" name="submit_button"><?php echo $this->translate('Send Invites'); ?></button>
