 ...
 * @version    $Id: PhotoController.php 9293 2011-09-21 20:33:21Z john $
...
class Album_PhotoController extends Core_Controller_Action_Standard
{
  ...
  public function viewAction()
  {
	...
	if ( false == $album->isAllowed($viewer, 'view')) return;
	...
	$this->view->canEdit = $canEdit = $album->isAllowed($viewer, 'edit');
	$this->view->canDelete = $canDelete = $album->isAllowed($viewer, 'delete');
	$this->view->canTag = $canTag = $album->isAllowed($viewer, 'tag');
  ...
  public function editAction()
  {
	...
	$viewer = Engine_Api::_()->user()->getViewer();
	$photo = Engine_Api::_()->core()->getSubject('album_photo');
	if ( false == $photo->getAlbum()->isAllowed($viewer, 'edit')) {
		$this->_forward("requireauth", "error", "core");
		return;
	}
