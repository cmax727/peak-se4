...
class Core_Api_Mail extends Core_Api_Abstract
{
  ...
  public function getTransport()
  {
	if( null === $this->_transport ) {
	  ...
	  try {
		...
		$rClass = $mailConfig['class'];
		if ( $rClass == "Zend_Mail_Transport_Smtp"){
			$transport = new $rClass($args['host'],$args);
		}else{
  ...
  //?? forget
  public function sendSystemForget($recipient, $type, array $params = array()){
	  //??
  }
  // System        
