...
class Core_Form_Admin_Settings_Wibiya extends Engine_Form
{
  public function init()
  {
    ...
    $description = $this->getTranslator()->translate(
        ...
        'create an account <a href="%1$s" target="_blank">here</a> and ' .
        'enter the URL to the javascript file below. You can configure ' . 
        'the toolbar through Wibiya\'s admin dashboard. The URL should look ' . 
        'like this: %2$s'
    );
