...
<script type="text/javascript">
  ...
  var changeSenderType = function(){
      if ( $('toType').value == "0"){
          $('to-wrapper').style.display="block";
          $('toNetworks-wrapper').style.display = 'none';
      }else{
          $('to-wrapper').style.display="none";
          $('toNetworks-wrapper').style.display = 'block';
      }
  };
