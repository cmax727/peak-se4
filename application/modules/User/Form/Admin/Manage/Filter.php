...
*/
	...
	$profile_id = 1;
	$optionsData = Engine_Api::_()->fields()->getFieldsOptions('user');
	$topLevelOptions = array(0=>' ');
	
	foreach( $optionsData->getRowsMatching('field_id', $profile_id) as $option ) 		{
	 ...
	 */
	//??
	$profile_type = new Zend_Form_Element_Select('profile_type');//profile_type
	$profile_type
